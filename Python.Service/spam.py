...
# Folder where this script + dataset live (cwd-independent)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

def main():
    # 1. Data Collection & Pre-Processing
    raw_mail_data = pd.read_csv(os.path.join(BASE_DIR, 'mail_data.csv'))
    ...
    dump((model, feature_extraction), os.path.join(BASE_DIR, 'spam_classifier_model.joblib'))
