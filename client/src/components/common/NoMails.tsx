...
import { MailOutlineOutlined, StarBorder, SendOutlined, DeleteSweepOutlined, DraftsOutlined, ReportGmailerrorred, Mail } from '@mui/icons-material';
...
const emptyIcons: Record<string, React.ReactNode> = {
  ...
  drafts: <DraftsOutlined style={{ fontSize: 60, color: '#5f6368' }} />,
  bin: <DeleteSweepOutlined style={{ fontSize: 60, color: '#5f6368' }} />,
  allmail: <Mail style={{ fontSize: 60, color: '#5f6368' }} />,
